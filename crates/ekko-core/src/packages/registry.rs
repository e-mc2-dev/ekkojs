...
pub struct RegistryConfig {
    ...
    #[serde(default)]
    pub x: std::collections::HashMap<String, String>,
}

impl Default for RegistryConfig {
    fn default() -> Self {

        Self { url: "https://bifrost.ekkojs.com".to_string(), token: None, accounts: Vec::new(), current: None, x: std::collections::HashMap::new() }
    }
}
