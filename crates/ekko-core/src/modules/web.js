...
function createServer(opts) {
  ...
  function dispatch(json, handle) {
    ...
    req.text = function() { return this.bodyBytes ? new TextDecoder().decode(this.bodyBytes) : (this.body || ''); };
    req.json = function() { try { return JSON.parse(this.text() || 'null'); } catch (e) { return null; } };
