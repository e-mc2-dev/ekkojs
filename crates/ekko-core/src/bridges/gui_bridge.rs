...
static GUI_IPC_RX: OnceLock<Arc<Mutex<mpsc::UnboundedReceiver<String>>>> = OnceLock::new();

pub fn init(sender: Box<dyn GuiSender>, rx: mpsc::UnboundedReceiver<String>) {
...
pub fn ipc_rx() -> Option<Arc<Mutex<mpsc::UnboundedReceiver<String>>>> {
