...
function useParams(){var s=useState(0),f=s[1];useEffect(function(){var c=function(){f(function(n){return n+1;});};_l.push(c);return function(){_l=_l.filter(function(x){return x!==c;});};},[]);return _p;}
...
if(typeof window!=='undefined'){window.__ekko_router_notify=_n;window.__ekko_router_set_params=function(p){_p=p;};}
export{createRouter,useRouter,useParams,useSearchParams,navigate};
