...
fn main() {
    ...
    writer.add_entry("src/index.js", br#"
export const name = "test-vfs-pkg";
export const version = "2.0.0";
export function greet(who) { return "Hello, " + who + "!"; }
export function identity(x) { return x; }
"#.to_vec());

    writer.add_entry("src/utils.js", br#"
...
"#.to_vec());
    ...
    writer.add_entry("src/math.js", br#"
...
"#.to_vec());
    ...
    println!("Generated {} ({} bytes, {} entries)", out_path, ekl_data.len(), 3);
}
