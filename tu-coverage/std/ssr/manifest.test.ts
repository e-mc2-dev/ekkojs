...
import { createApp, readManifest, resolvePageAssets } from "ekko:rune";
...
describe("resolvePageAssets", () => {
  ...
  test("resolves page with file+imports format", () => {
    ...
    expect(assets.modulepreload[0]).toBe("/_ekko/_hydrate-abc123.js");
    expect(assets.modulepreload[1]).toBe("/_ekko/pages/index-def456.js");
    expect(assets.modulepreload[2]).toBe("/_ekko/chunks/chunk-xyz789.js");
  });
  ...
  test("resolves page with string format (backward compat)", () => {
    ...
    expect(assets.modulepreload.length).toBe(2);
    expect(assets.modulepreload[0]).toBe("/_ekko/_hydrate-abc.js");
    expect(assets.modulepreload[1]).toBe("/_ekko/pages/index-def.js");
  });
  ...
  test("custom prefix", () => {
    ...
    expect(assets.modulepreload[0]).toBe("/static/_hydrate.js");
    expect(assets.modulepreload[2]).toBe("/static/chunks/c.js");
  });
  ...
  test("multiple imports resolved", () => {
    ...
    expect(assets.modulepreload.length).toBe(5);
    expect(assets.modulepreload[2]).toBe("/_ekko/chunks/react.js");
    expect(assets.modulepreload[3]).toBe("/_ekko/chunks/vendor.js");
    expect(assets.modulepreload[4]).toBe("/_ekko/chunks/utils.js");
  });
});
